...
export default async function SiteOverviewPage({
  ...
  const checklist: {
  ...
  }[] = [
    {
      ...
      desc: "Free: pull crawl errors + indexation from Search Console, Core Web Vitals from PageSpeed Insights.",
    ...
    },
    {
      ...
      desc: "Free: Search Console's Performance report shows queries you already get impressions for.",
    ...
    },
    {
      ...
      desc: "Best-of lists, comparisons, and alternatives pages get quoted by AI most often — start with one of those.",
    ...
    },
    {
      ...
      desc: "Free: Search Console's Links report shows every site linking to you, no lookup limit.",
    ...
    },
    {
      ...
      desc: "Open an incognito window, ask a real buyer question, see if this site gets named.",
    ...
    },
    {
      ...
      desc: "Free: GA4 → Acquisition report filtered to Organic Search.",
